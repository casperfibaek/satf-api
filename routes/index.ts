...
router.route('/get_user_layer_metadata').get(auth, get_user_layer_metadata)
router.route('/get_layer_geoms').get(auth, get_layer_geoms)
router.route('/delete_layer').get(auth, delete_layer)
router.route('/update_layer_data').post(auth, update_layer_data)
router.route('/create_layer').post(auth, create_layer)
